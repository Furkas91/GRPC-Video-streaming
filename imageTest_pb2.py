...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0fimageTest.proto\"\x19\n\nMsgRequest\x12\x0b\n\x03img\x18\x01 \x01(\x0c\"\x19\n\x08MsgReply\x12\r\n\x05reply\x18\x01 \x01(\x0c\x32Z\n\tImageTest\x12%\n\x07\x41nalyse\x12\x0b.MsgRequest\x1a\t.MsgReply(\x01\x30\x01\x12&\n\x0cUnaryAnalyse\x12\x0b.MsgRequest\x1a\t.MsgReplyB\x08P\x01\xa2\x02\x03HLWb\x06proto3'
)
...
_IMAGETEST = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UnaryAnalyse',
    full_name='ImageTest.UnaryAnalyse',
    index=1,
    containing_service=None,
    input_type=_MSGREQUEST,
    output_type=_MSGREPLY,
